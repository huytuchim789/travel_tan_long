		...
		<div class="blog-grid row">
			...
			<div class="blog-grid-entry col-mob-12 col-xs-12 col-sm-6 col-md-4">
				<div class="s_news-entry style-2">
					<a href="{{ route('home.single.tours', $blog->slug) }}"><img style="height: 250px;" class="s_news-img img-responsive" src="{{ Storage::disk('local')->url($blog->image) }}" alt=""></a>
					<h4 class="s_news-title"><a href="{{ route('home.single.tours', $blog->slug) }}">{{ str_limit($blog->title, 35) }}</a></h4>
					...
					<a href="{{ route('home.single.tours', $blog->slug) }}" class="c-button small bg-dr-blue-2 hv-dr-blue-2-o"><span>Xem thêm</span></a>						  	 	
				</div>				
			</div>
			@endforeach
